...
# ----------------手动配置区---------------
accessKey =cDbKuhE-1OgoUcQtQrw8kHNImX8I_l4rklPS--d8
secretkey =s-M39WD_n8tEm1uP5T3kFML8f3Ghr9nC3X8bXyYc
# 上传空间的域名，需要自己去后台获取
bucket_url = {
    CDN:re34ccr7.bkt.clouddn.com,
}
bucket =shiyanlouphoto  # 上传空间
